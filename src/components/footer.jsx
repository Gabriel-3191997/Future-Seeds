        ...
        return (
            <>
                <footer className="bg-white rounded-none border-none font-serif m-4 reveal-up reveal-delay-5">
                    <div className="w-full mx-auto max-w-7xl p-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <span className="text-sm text-body text-center md:text-left">
                            © 2026 <a href="https://flowbite.com/" className="hover:underline">Future Seeds</a>. All Rights Reserved.
                        </span>
                        <ul className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-sm sm:text-lg font-medium text-body md:justify-end">
                            ...
                            <li>
                                <a href="#" className="hover:underline">LegalPolicy</a>
                            </li>
                            <li>
